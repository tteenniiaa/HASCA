...
public class Penyakit10 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_penyakit10);
        ...
        btnselanjutnya.setOnClickListener(new View.OnClickListener() {
                                              ...
                                              public void onClick(View argo) {
                                                  ...
                                                  Intent next = new Intent (getApplicationContext(), Penyakit11.class);
                                                  startActivity(next);
                                                  finish();
                                              }
                                          }
        ...
        btnsebelumnya.setOnClickListener(new View.OnClickListener() {
                                             ...
                                             public void onClick(View argo) {
                                                 ...
                                                 Intent prev = new Intent (getApplicationContext(), Penyakit9.class);
                                                 startActivity(prev);
                                                 finish();
                                             }
                                         }
