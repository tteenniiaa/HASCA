...
public class Penyakit12 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_penyakit12);
        ...
        btnselanjutnya.setOnClickListener(new View.OnClickListener() {
                                              ...
                                              public void onClick(View argo) {
                                                  ...
                                                  Intent next = new Intent (getApplicationContext(), Penyakit1.class);
                                                  startActivity(next);
                                                  finish();
                                              }
                                          }
        ...
        btnsebelumnya.setOnClickListener(new View.OnClickListener() {
                                             ...
                                             public void onClick(View argo) {
                                                 ...
                                                 Intent prev = new Intent (getApplicationContext(), Penyakit11.class);
                                                 startActivity(prev);
                                                 finish();
                                             }
                                         }
